...
-- Motor: PostgreSQL 17 | Puerto: 5432
-- Crear: docker compose up -d (POSTGRES_DB=importadora_vehiculos)
-- =============================================================================

-- CREATE DATABASE importadora_vehiculos;  -- ya creada por Docker
...
CREATE TABLE IF NOT EXISTS clientes (
    ...
    ciudad               VARCHAR(80),
    notas                VARCHAR(500),
    tipo_cliente         VARCHAR(20)  NOT NULL DEFAULT 'REGULAR',  -- VIP | REGULAR | NUEVO
...
ALTER TABLE clientes
    ADD CONSTRAINT IF NOT EXISTS fk_clientes_vendedor
...
CREATE TABLE IF NOT EXISTS importaciones (
    ...
    ms2_embarque_id         VARCHAR(64),   -- enlace → MS-2
